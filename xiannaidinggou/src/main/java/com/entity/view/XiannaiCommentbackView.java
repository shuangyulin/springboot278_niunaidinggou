...
public class XiannaiCommentbackView extends XiannaiCommentbackEntity implements Serializable {
	...
	public XiannaiCommentbackView() {

	}

	public XiannaiCommentbackView(XiannaiCommentbackEntity xiannaiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, xiannaiCommentbackEntity);
