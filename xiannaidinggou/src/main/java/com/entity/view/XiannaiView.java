 ...
 */
@TableName("xiannai")
public class XiannaiView extends XiannaiEntity implements Serializable {
	...
	public XiannaiView(XiannaiEntity xiannaiEntity) {
		try {
			BeanUtils.copyProperties(this, xiannaiEntity);
