    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                XiannaiEntity xiannai = xiannaiService.selectById(cart.getXiannaiId());
                if(xiannai != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("xiannai_id", cart.getXiannaiId())
...
//                            cartEntity.setXiannaiId(Integer.valueOf(data.get(0)));   //商品 要改的
