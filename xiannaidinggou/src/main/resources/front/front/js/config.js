...
var centerMenu = [
    ...
    ,{
        name: '商品收藏',
        url: '../xiannaiCollection/list.html'
    }
    ,{
        name: '商品订单',
        url: '../xiannaiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '商品',
        url: './pages/xiannai/list.html'
    },

]

var adminurl =  "http://localhost:8080/xiannaidinggou/admin/dist/index.html#/login";
